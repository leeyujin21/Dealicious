    ...
    return (
        <div className='main' style={{overflow:"scroll", height:"742px", overflowX:"hidden", paddingTop:"50px"}}>
            ...
            <div style={{textAlign:"left"}}>
                &nbsp;
                <Link to="/mypage" style={{fontSize:"18px", fontWeight:"bold", color:"black", textDecoration:"none"}}>내가 쓴 글(9)</Link>&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <div style={{ display:"inline-block", paddingRight:"10px"}}>
                <div style ={{width:"100px", height:"100px", 'background-color':"red", borderRadius:"10px", position:"relative", opacity:"0.5"}}>
                    <div style={{height:"35px"}}/>
                    <a style={{fontWeight:"bold", verticalAlign:"center", color:"white"}}>예약중</a>
                </div>
                <div style={{textAlign:"left"}}>
                    50,000원
                </div>
                <div style={{textAlign:"left"}}>
                    <a style={{fontSize:"13px"}}>접시 세트 판매..</a>
                </div>
            </div>
            <div style={{ display:"inline-block", paddingRight:"10px"}}>
                <div style ={{width:"100px", height:"100px", 'background-color':"red", borderRadius:"10px", position:"relative", opacity:"0.5"}}>

        ...
        <div className='main' style={{ textAlign: 'left', overflow: "scroll", height: "742px", overflowX: "hidden" }}>
            ...
            <div style={{ marginTop: "15px" }}>
                <div style={{display:"flex"}}>
                    ...
                    <div>
                        <select  style={{border:"1px solid lightgray", marginTop:"12.5px", borderRadius: "10px", width: "130px", height: "45px", textAlign: "left" }}>
...
A동 8층까지 오시면 5천원 깎아드려요.">
            ...
            <div style={{ display: "flex" }}>
                ...
                <span style={{ textAlign: "right" }}><input type="submit" value="수정하기" style={{ borderRadius: "5px", width: "100px", height: "45px", backgroundColor: '#14C38E', color: "white", borderStyle: "none" }}></input></span>
            </div>
        </div>
    );
};

    ...
    return (
        <div className='main' style={{ textAlign: 'left', overflow: "scroll", height: "732px", overflowX: "hidden" }}>
            <div style={{marginTop:"10px", marginBottom:"20px"}}>
                ...
                <span style={{ color: "#14C38E", fontSize: "25px", textAlign: "center", marginLeft: "75px" }}><b>LG TV 팝니다!</b></span>
            </div>

            <img src="./2.png" style={{ width: "385px", height: "210px", borderRadius:"10px"}} />
            ...
            <tr>
                <td style={{ textAlign: "left", width:"200px" }}>장소: B동 1층근처</td>
                <td style={{ width: "250px", fontWeight: "bold",textAlign:"right" }}>가격: 332,000원</td>
            </tr>
            <Input type="textarea" style={{ width: "385px", marginTop: "10px", marginBottom: "15px", height: "300px", resize: "none", backgroundColor: "white" }} disabled
                value="LG TV 팔아요! B동 1층까지 오시면 2만원 깎아드려요.">

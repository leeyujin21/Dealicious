...
function SaleModify(){
    return(
        ...
        <span style={{color:"#14C38E" ,fontSize:"25px" ,textAlign:"center",marginLeft:"60px"}}><b>판매글 수정</b></span>
       
         
         </div>
            <br/>
           <img src="./cam1.png" style={{width:"50px", height:"50px"}}className='image'></img>
        ...
        <div className='textarea'>
            ...
            상세설명 <textarea cols="40" rows="10" placeholder="디스펜서 팔아요!
            산지는 3개월 됐는데
            거의 안 써서 미개봉 제품이랑 별 차이
            없습니다!
            A동 8층까지 오시면 5천원 깎아드려요 "style={{borderRadius:"10px",width:"328px",height:"300px",padding:"30px"}}></textarea>
            
        </div>
        <br/>
        <p style={{textAlign:"center"}}><input type="submit" value="수정하기" style={{borderRadius:"10px",width:"328px", height:"50px",backgroundColor:'#14C38E',color:"white"}}></input></p>

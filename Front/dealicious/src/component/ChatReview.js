...
const ChatReview = () => {
  ...
  return (
    <div className='main' style={{ overflow: "scroll", height: "742px", overflowX: "hidden" }}>
      ...
      <div><button style={{width:"310px", backgroundColor:"#C7FBEB", border:"white", padding:"5px",borderRadius:"10px",  color:"#14C38E",fontWeight:"bold"}} onClick={()=>setModalIsOpen(true)}>후기 작성하기</button> 
      <Modal style={{
                content: {

    ...
    return (
        <div className='main' style={{overflow:"scroll", height:"742px", overflowX:"hidden", paddingTop:"50px"}}>
            ...
            <FormGroup style={{textAlign:"left"}}>
                ...
                <Input type="password" name="newpw" id="newpw" style={{height:"55px", width:"330px"}}
                    placeholder="새 비밀번호를 입력하세요"/>
            </FormGroup>
            <FormGroup style={{textAlign:"left"}}>
                <Label for="newpwrp" style={{fontSize:"20px"}}>비밀번호 다시 입력하기</Label>
                <Input type="password" name="newpwrp" id="newpwrp" style={{height:"55px", width:"330px"}}
                    placeholder="한 번 더 입력하세요"/>
            </FormGroup>
            <br/> <br/> <br/>
            <Link to="/join4">
                <Button style={{width:"330px", height:"55px", fontSize:"20px", backgroundColor:"#14C38E", borderStyle:"none"}}>변경하기</Button>
            </Link>
        </div>
    )
}
